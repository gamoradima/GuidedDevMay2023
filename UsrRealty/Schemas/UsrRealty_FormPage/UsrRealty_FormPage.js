...
define("UsrRealty_FormPage", /**SCHEMA_DEPS*/["@creatio-devkit/common"]/**SCHEMA_DEPS*/, function/**SCHEMA_ARGS*/(sdk)/**SCHEMA_ARGS*/ {
	return {
		viewConfigDiff: /**SCHEMA_VIEW_CONFIG_DIFF*/[
			...
			{
				"operation": "insert",
				"name": "Button_RunWebService",
				"values": {
					"type": "crt.Button",
					"caption": "#ResourceString(Button_f5cshya_caption)#",
					"color": "warn",
					"disabled": false,
					"size": "medium",
			...
			},
			{
				...
				"values": {
					"type": "crt.Button",
					"caption": "#ResourceString(Button_85zldy4_caption)#",
					"color": "accent",
					"disabled": false,
					"size": "medium",
					"iconPosition": "only-text",
			...
			{
				"operation": "insert",
				"name": "MenuItem_q0c8cf8",
				"values": {
					"type": "crt.MenuItem",
					"caption": "#ResourceString(MenuItem_q0c8cf8_caption)#",
					"visible": true,
					"clicked": {
		...
		handlers: /**SCHEMA_HANDLERS*/[
			{
				...
				handler: async (request, next) => {
					...
					var typeObject = await request.$context.LookupAttribute_y15o9fm;
					var typeId = "";
					if (typeObject) {
					...
					var offerTypeObject = await request.$context.LookupAttribute_qnaugco;
					var offerTypeId = "";
					if (offerTypeObject) {
